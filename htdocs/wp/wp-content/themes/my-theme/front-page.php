...
<main id="main" aria-label="本文">
  ...
  <div class="contentInner">
    <div class="grid gap-40 py-60">
      ...
      <div>
        <h2 class="text-h2 mb-16">機能紹介</h2>
      ...
      <div>
        <h2 class="text-h2 mb-16">テキストサンプル</h2>
        <p class="text-base">あのイーハトーヴォのすきとおった風、夏でも底に冷たさをもつ青いそら、うつくしい森で飾られたモリーオ市、郊外のぎらぎらひかる草の波。また、その奥羽山脈の重畳たる稜線は、濃紫のなつかしい線となって、東北の空にひかえている。</p>
      </div>

      <div>
        <h2 class="text-h2 mb-16">Pictureコンポーネントデモ</h2>
        ...
        <div class="picture-demo-container">
          <img src="<?= get_template_directory_uri() ?>/_assets/img/top/sample.png" alt="Astroサンプルサイトのデモ画像" width="800" height="600" class="picture-demo-image" loading="lazy" decoding="async" fetchpriority="auto">
        </div>
      </div>
    </div>
  </div>
