...
function setSlide(element, delay = 1e4, auto = true) {
  ...
  if (slideElement.length > 0) {
    elementArr.forEach((element2) => {
      const bar = element2.querySelector(".c_slide_bar");
      const counter = element2.querySelector(".c_slide_counter");
      const slide = new Splide(element2, {
        arrows: true,
        type: "fade",
        speed: 2400,
        autoplay: auto,
      ...
      if (counter) {
        let slideIndex = function(counter2) {
          const slideCurrent = counter2.querySelector(".c_slide_counter_current");
          const slideLength = counter2.querySelector(".c_slide_counter_length");
          if (slideCurrent) {
